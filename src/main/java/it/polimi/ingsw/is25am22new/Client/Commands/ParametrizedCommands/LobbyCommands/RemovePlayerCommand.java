...
public class RemovePlayerCommand extends AbstractParametrizedCommand {

    public RemovePlayerCommand(VirtualServer virtualServer, ClientModel clientModel) {
    ...
    public void execute() {
        try{
            virtualServer.removePlayer(clientModel.getPlayerName());
        }
        catch(Exception e){
