...
import it.polimi.ingsw.is25am22new.Client.Commands.ParametrizedCommands.ShipBuildingPhaseCommands.PickStandByComponentTileCommand;
...
public class PickStandByComponentTileCommandType extends AbstractCommandType {

    public PickStandByComponentTileCommandType(VirtualServer virtualServer) {
        super(virtualServer);
    }

    @Override
    public String getName() {
        return "Pick StandBy Component Tile";
    }
    ...
    public ParametrizedCommand createWithInput(ClientModel clientModel, List<Integer> input, ViewAdapter viewAdapter) {
        return new PickStandByComponentTileCommand(virtualServer, clientModel, input);
    }

    @Override
    public String getInputRequest() {
        return "Enter index of the tile you want to pick: [0, 1]";
    }
}
