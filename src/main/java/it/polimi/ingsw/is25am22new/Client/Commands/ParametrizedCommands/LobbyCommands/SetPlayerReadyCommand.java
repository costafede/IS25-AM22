...
public class SetPlayerReadyCommand extends AbstractParametrizedCommand {
    public SetPlayerReadyCommand(VirtualServer virtualServer, ClientModel clientModel) {
    ...
    public void execute() {
        try{
            virtualServer.setPlayerReady(clientModel.getPlayerName());
        }
        catch(Exception e){
